  ...
  return (
    <div className="px-4 py-6 md:px-6 lg:py-16 md:py-12">
      <article className="prose prose-gray mx-auto dark:prose-invert">
        ...
        <p>
          This is a sample paragraph for a minimalistic post. The content of the
          post would go here. This could include text, images, links, and other
          elements.
        </p>
        <figure>
          <img
